...
Creep.prototype = _.extend(Object.create(RoomObject.prototype),
  {
    /**
     ...
     * The target has be at adjacent square to the creep.
     *
     * @type {function}
     *
    ...
    getActiveBodyparts: function(type) {
      return _.filter(this.body, b => b.type === type).length;
    },
